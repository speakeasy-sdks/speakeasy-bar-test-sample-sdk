...
class Application 
{
    ...
    ): \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\CreateApplicationResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->applicationApiOut = $serializer->deserialize((string)$httpResponse->getBody(), 'speakeasy_bar-test\Risk-Cloud-API\Models\Components\ApplicationApiOut', 'json');
            }
        }
    ...
    ): \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\ReadAllApplicationsResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->pageModelOutApplicationApiOut = $serializer->deserialize((string)$httpResponse->getBody(), 'speakeasy_bar-test\Risk-Cloud-API\Models\Components\PageModelOutApplicationApiOut', 'json');
            }
        }
