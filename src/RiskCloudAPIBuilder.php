...
/**
 * RiskCloudAPIBuilder is used to configure and build an instance of the SDK.
 * 
 * @package speakeasy_bar-test\Risk-Cloud-API
 */
class RiskCloudAPIBuilder
{
     ...
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): RiskCloudAPIBuilder
    {
     ...
     * @return RiskCloudAPIBuilder
     */
    public function setSecurity(Models\Components\Security $security): RiskCloudAPIBuilder
    {
     ...
     * @return RiskCloudAPIBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): RiskCloudAPIBuilder
    {
     ...
     * @return RiskCloudAPIBuilder
     */
    public function setServerIndex(int $serverIdx): RiskCloudAPIBuilder
    {
     ...
     * @return RiskCloudAPI
     */
    public function build(): RiskCloudAPI
    {
        ...
        return new RiskCloudAPI($this->sdkConfig);
    }
}