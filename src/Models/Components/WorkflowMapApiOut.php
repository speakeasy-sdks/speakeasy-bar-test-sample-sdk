...
class WorkflowMapApiOut
{
     ...
     * 
     * @var ?\speakeasy_bar-test\Risk-Cloud-API\Models\Components\WorkflowMapApiOutRelationship $relationship
     */
	#[\JMS\Serializer\Annotation\SerializedName('relationship')]
    #[\JMS\Serializer\Annotation\Type('enum<speakeasy_bar-test\Risk-Cloud-API\Models\Components\WorkflowMapApiOutRelationship>')]
    #[\JMS\Serializer\Annotation\SkipWhenEmpty]
