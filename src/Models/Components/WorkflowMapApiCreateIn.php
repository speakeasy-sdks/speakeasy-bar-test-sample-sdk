...
class WorkflowMapApiCreateIn
{
     ...
     * 
     * @var \speakeasy_bar-test\Risk-Cloud-API\Models\Components\Relationship $relationship
     */
	#[\JMS\Serializer\Annotation\SerializedName('relationship')]
    #[\JMS\Serializer\Annotation\Type('enum<speakeasy_bar-test\Risk-Cloud-API\Models\Components\Relationship>')]
	...
	{
		$this->from = "";
		$this->relationship = \speakeasy_bar-test\Risk-Cloud-API\Models\Components\Relationship::OneToOne;
		$this->to = "";
	}
}
