...
class Workflow 
{
    ...
    ): \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\CreateWorkflowResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response->workflowApiOut = $serializer->deserialize((string)$httpResponse->getBody(), 'speakeasy_bar-test\Risk-Cloud-API\Models\Components\WorkflowApiOut', 'json');
            }
        }
    ...
    ): \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\ReadAllWorkflowsResponse
    {
        ...
        if ($httpResponse->getStatusCode() === 200) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                $serializer = Utils\JSON::createSerializer();
                $response->pageModelOutWorkflowApiOut = $serializer->deserialize((string)$httpResponse->getBody(), 'speakeasy_bar-test\Risk-Cloud-API\Models\Components\PageModelOutWorkflowApiOut', 'json');
            }
        }
