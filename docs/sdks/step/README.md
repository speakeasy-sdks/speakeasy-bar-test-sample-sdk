...
use \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\CreateStepRequest;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\StepApiCreateIn;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\StepApiCreateInAssignableUserType;
...
try {
    $request = new CreateStepRequest();
    $request->stepApiCreateIn = new StepApiCreateIn();
    $request->stepApiCreateIn->assignableUserType = StepApiCreateInAssignableUserType::AppUsers;
...
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\Security;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\SchemeBasic;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\DeleteStepRequest;
...
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\Security;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\SchemeBasic;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\ReadStepRequest;
...
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\Security;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\SchemeBasic;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\ReadAllStepsRequest;
...
try {
    $request = new ReadAllStepsRequest();
    $request->page = 853380;
    $request->size = 87498;
...
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\Security;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\SchemeBasic;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Operations\UpdateRequest;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\StepApiUpdateIn;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\StepApiUpdateInAssignableUserType;
use \speakeasy_bar-test\Risk-Cloud-API\Models\Shared\StepApiUpdateInType;
...
try {
    ...
    $request->stepApiUpdateIn = new StepApiUpdateIn();
    $request->stepApiUpdateIn->assignableUserType = StepApiUpdateInAssignableUserType::AppUsers;
    ...
    $request->stepApiUpdateIn->type = StepApiUpdateInType::Origin;
